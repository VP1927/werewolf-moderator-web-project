      ...
      if ((globalState.pNum <= sum) && (sum <= globalState.pNum+2)){
        ...
        for (chosen in chosenList){
          ...
          if ((chosenList[chosen]>0)){
            ...
            // if (globalState.cards.indexOf(this.state.cardList[chosen].idCard)===-1){
            //   globalState.cards.push(this.state.cardList[chosen].idCard);
            // }
            globalState.cards.push(this.state.cardList[chosen].idCard);
          ...
          //   if (globalState.cards.indexOf(this.state.cardList[chosen].idCard)!==-1){
          //       globalState.cards.splice(globalState.cards.indexOf(this.state.cardList[chosen].idCard),0);
          //   }
          // }
        }
        alert('starting game');
